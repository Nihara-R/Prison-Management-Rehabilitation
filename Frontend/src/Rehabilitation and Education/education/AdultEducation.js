...
const AdultEducation = () => {
    ...
    const filteredEducations = educations.filter(education =>
        education.programName.toLowerCase().includes(searchQuery.toLowerCase()) && education.category === 'Adult Basic Education Initiatiove'
    );
            ...
            <div className='flex gap-2'>
                ...
                <div>
                    <div className='w-full'>
                        <h1 className='py-6 text-2xl font-bold text-center'>Adult Basic Program</h1>
