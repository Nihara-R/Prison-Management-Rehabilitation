...
const AddEducation = ({ isOpen, onClose, refreshList }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('http://localhost:3500/api/education/add', educationData);
    ...
    return (
        <div className={`fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50 z-50 ${isOpen ? 'block' : 'hidden'}`}>
            <div className="bg-white p-6 rounded-lg max-w-[50%] relative" >
                ...
                <div>
                    <h2 className='p-4 text-xl font-semibold text-center'>Add New Education Program</h2>
